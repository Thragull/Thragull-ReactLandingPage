      ...
      <div className='container-fluid'>
        ...
        <div className="collapse navbar-collapse" id="navbarSelector">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li className='nav-item'>
              <a className="nav-link text-white active text-start ms-5 ms-lg-0" aria-current="page" href="#">About</a>
            </li>
            <li className='nav-item'>
              <a className="nav-link text-white active text-start ms-5 ms-lg-0" aria-current="page" href="#">Services</a>
            </li>
            <li className='nav-item'>
              <a className="nav-link text-white active text-start ms-5 ms-lg-0 me-lg-3" aria-current="page" href="#">Contact</a>
            </li>
          </ul>
        </div>
      </div>
